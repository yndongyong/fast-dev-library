package org.yndongyong.fastandroid.executor;
...
public class BackgroundExecutors {
    private static BackgroundExecutors instance = new BackgroundExecutors();
    ...
    /**
     * Cancels the execution of a scheduled task. {@link TimerTask#cancel()}
     *
